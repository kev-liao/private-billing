...
pub fn poseidon<F: PrimeField>() -> PoseidonParameters<F> {
    let alpha = 17;
    let mds = vec![
        vec![
            F::from_str(
...
mod test {
    ...
    fn sponge_test() {
        ...
        let sponge_params: PoseidonParameters<Fr> = poseidon();        
        ...
        let squeeze1 = native_sponge.squeeze_bytes(32);
        let squeeze2 = constraint_sponge.squeeze_bytes(32).unwrap();
